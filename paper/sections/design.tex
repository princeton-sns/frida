...
Each client library utilizes a dependence graph of events to detect a malicious server which may drop or reorder messages.
...
\texttt{
    events: set of events, event -> [hash, dependencies, revDependencies, local sequeence number] \\ \\
